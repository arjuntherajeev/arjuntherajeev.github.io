---
title: "VulnHub: The Necromancer: 1 Walkthrough"
date: "2019-05-26"
...
![Screen Shot 2019-05-26 at 4.35.00 PM](images/screen-shot-2019-05-26-at-4.35.00-pm.png)
...
![Screen Shot 2019-05-26 at 4.41.29 PM](images/screen-shot-2019-05-26-at-4.41.29-pm.png)
...
![Screen Shot 2019-05-26 at 4.53.50 PM](images/screen-shot-2019-05-26-at-4.53.50-pm.png)
...
![Screen Shot 2019-05-26 at 7.48.55 PM](images/screen-shot-2019-05-26-at-7.48.55-pm.png)
...
![Screen Shot 2019-05-26 at 8.00.02 PM](images/screen-shot-2019-05-26-at-8.00.02-pm.png)
...
![Screen Shot 2019-05-26 at 8.10.56 PM](images/screen-shot-2019-05-26-at-8.10.56-pm.png)
...
![Screen Shot 2019-05-26 at 8.18.21 PM](images/screen-shot-2019-05-26-at-8.18.21-pm.png)
...
![Screen Shot 2019-05-26 at 8.21.42 PM](images/screen-shot-2019-05-26-at-8.21.42-pm.png)
...
![Screen Shot 2019-05-26 at 8.36.27 PM.png](images/screen-shot-2019-05-26-at-8.36.27-pm.png)

Yes, port `80` was open for business. Time to hit the browser!

![Screen Shot 2019-05-26 at 8.42.18 PM](images/screen-shot-2019-05-26-at-8.42.18-pm.png)
...
![Screen Shot 2019-05-26 at 9.20.39 PM](images/screen-shot-2019-05-26-at-9.20.39-pm.png)

Nothing exciting here. I decided to try again with the `binwalk` tool: `binwalk pileoffeathers.jpg`

![Screen Shot 2019-05-26 at 9.23.19 PM](images/screen-shot-2019-05-26-at-9.23.19-pm.png)
...
![Screen Shot 2019-05-26 at 9.27.40 PM](images/screen-shot-2019-05-26-at-9.27.40-pm.png)

Let's have a look at `feathers.txt`

![Screen Shot 2019-05-26 at 9.29.43 PM](images/screen-shot-2019-05-26-at-9.29.43-pm.png)
...
![Screen Shot 2019-05-26 at 9.48.22 PM](images/screen-shot-2019-05-26-at-9.48.22-pm.png)
...
![Screen Shot 2019-05-26 at 10.04.17 PM](images/screen-shot-2019-05-26-at-10.04.17-pm.png)
...
![Screen Shot 2019-05-26 at 11.15.29 PM.png](images/screen-shot-2019-05-26-at-11.15.29-pm.png)

Well look what we have here! A binary file!

After setting the right permissions (`chmod +x talisman`), I ran it...

![Screen Shot 2019-05-26 at 11.18.55 PM.png](images/screen-shot-2019-05-26-at-11.18.55-pm.png)
...
![Screen Shot 2019-05-27 at 2.41.00 PM.png](images/screen-shot-2019-05-27-at-2.41.00-pm.png)
...
![Screen Shot 2019-05-27 at 2.42.47 PM](images/screen-shot-2019-05-27-at-2.42.47-pm.png)
...
`if input == password:` `    call correct()` `else:` `    call incorrect()`
...
![Screen Shot 2019-05-27 at 2.49.06 PM.png](images/screen-shot-2019-05-27-at-2.49.06-pm.png)
...
![Screen Shot 2019-05-27 at 2.53.55 PM.png](images/screen-shot-2019-05-27-at-2.53.55-pm.png)
...
![Screen Shot 2019-05-27 at 2.56.02 PM.png](images/screen-shot-2019-05-27-at-2.56.02-pm.png)
...
![Screen Shot 2019-05-27 at 3.00.39 PM](images/screen-shot-2019-05-27-at-3.00.39-pm.png)

MD5? Again? Back to my trusted [MD5 online website](https://www.md5online.org/md5-decrypt.html) in hopes of finding the matching hash in their database. ![Screen Shot 2019-05-27 at 3.02.21 PM.png](images/screen-shot-2019-05-27-at-3.02.21-pm.png)

Found it - `blackmagic`

![Screen Shot 2019-05-27 at 3.03.53 PM.png](images/screen-shot-2019-05-27-at-3.03.53-pm.png)
...
![Screen Shot 2019-05-27 at 3.10.08 PM](images/screen-shot-2019-05-27-at-3.10.08-pm.png)

Wait... there's more if you scroll down...

![Screen Shot 2019-05-27 at 3.11.09 PM.png](images/screen-shot-2019-05-27-at-3.11.09-pm.png)

We got the sixth flag! Flag 6 is `b1c3ed8f1db4258e4dcb0ce565f6dc03`.

Reading through the message reveals 2 important points:

1. In the sentence - `It's the necromancer!` there is a reference link in the word `necromancer` to `http://192.168.56.101/thenecromancerwillabsorbyoursoul/necromancer` which will download a binary file.
...
![Screen Shot 2019-05-27 at 3.59.43 PM.png](images/screen-shot-2019-05-27-at-3.59.43-pm.png)

Uh oh! Not a binary? What?

![Screen Shot 2019-05-27 at 4.00.44 PM.png](images/screen-shot-2019-05-27-at-4.00.44-pm.png)

Bzip2 compression! Not a problem. Easy enough to decompress it with: `bzip2 -d necromancer`

![Screen Shot 2019-05-27 at 6.37.24 PM](images/screen-shot-2019-05-27-at-6.37.24-pm.png)

Okay, we now have `necromancer.out`. Let's see what is inside...

![Screen Shot 2019-05-27 at 6.38.51 PM.png](images/screen-shot-2019-05-27-at-6.38.51-pm.png)
...
![Screen Shot 2019-05-27 at 6.40.43 PM.png](images/screen-shot-2019-05-27-at-6.40.43-pm.png)
...
![Screen Shot 2019-05-27 at 6.56.23 PM.png](images/screen-shot-2019-05-27-at-6.56.23-pm.png) Looking at the packet capture, I understood that it was Wi-Fi traffic. With a `.cap` file and the knowledge that Wi-Fi traffic exists within it, I decided to go with my trusty tool - `aircrack-ng` with hopes of breaking the password.
...
![Screen Shot 2019-05-27 at 6.55.46 PM.png](images/screen-shot-2019-05-27-at-6.55.46-pm.png)
...
![Screen Shot 2019-05-27 at 7.09.50 PM.png](images/screen-shot-2019-05-27-at-7.09.50-pm.png)
...
![Screen Shot 2019-05-27 at 7.17.38 PM.png](images/screen-shot-2019-05-27-at-7.17.38-pm.png)
...
![Screen Shot 2019-05-27 at 7.22.54 PM.png](images/screen-shot-2019-05-27-at-7.22.54-pm.png)
...
![Screen Shot 2019-05-27 at 8.43.29 PM.png](images/screen-shot-2019-05-27-at-8.43.29-pm.png)
...
![Screen Shot 2019-05-27 at 8.51.15 PM.png](images/screen-shot-2019-05-27-at-8.51.15-pm.png)
...
![Screen Shot 2019-05-27 at 8.53.47 PM.png](images/screen-shot-2019-05-27-at-8.53.47-pm.png)
...
![Screen Shot 2019-05-27 at 8.59.04 PM](images/screen-shot-2019-05-27-at-8.59.04-pm.png)
...
![Screen Shot 2019-05-27 at 9.08.29 PM.png](images/screen-shot-2019-05-27-at-9.08.29-pm.png)

Got it! `12345678` ... really `demonslayer`? Time to SSH!

![Screen Shot 2019-05-27 at 9.10.01 PM.png](images/screen-shot-2019-05-27-at-9.10.01-pm.png)
...
![Screen Shot 2019-05-27 at 9.14.17 PM.png](images/screen-shot-2019-05-27-at-9.14.17-pm.png)
...
![Screen Shot 2019-05-27 at 9.28.00 PM.png](images/screen-shot-2019-05-27-at-9.28.00-pm.png)
...
![Screen Shot 2019-05-27 at 9.38.38 PM.png](images/screen-shot-2019-05-27-at-9.38.38-pm.png)
...
![Screen Shot 2019-05-27 at 9.49.40 PM.png](images/screen-shot-2019-05-27-at-9.49.40-pm.png)
...
![Screen Shot 2019-05-27 at 9.51.49 PM.png](images/screen-shot-2019-05-27-at-9.51.49-pm.png)
